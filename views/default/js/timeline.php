...
// Timeline functions @todo clean this up
...
$(document).ready(function () {
	...
	$("#tagdashboard-timeline").mouseup(function(){
		mouseUp = true;
		displaymsg("Mouse up!");
	}).mousedown(function(){
		mouseUp = false;
...
function onLoad() {
    var tl_el = document.getElementById("tagdashboard-timeline");
	tl = tl_el;
    ...
    tl.loadJSON(json_data_url + "?type=detailed", function(json, url) {
		 ...
		 tl.getBand(0).setCenterVisibleDate(detailedSource.getLatestDate());
		 tl.getBand(1).setCenterVisibleDate(detailedSource.getLatestDate()); // Center the timline on last entry
